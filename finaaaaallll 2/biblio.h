...
void tp(char tuile[3][3], int *x, int *y, int *x2, int *y2, int *x3, int *y3, int *x4, int *y4, int *erreur, int *erreur2, int *erreur3, int *erreur4, char *tp, char *tp2, char *tp3, char *tp4, char plato[21][27]);
